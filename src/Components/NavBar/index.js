  ...
  return (
    <nav className="navbar-container">
      ...
      <div className={`navbar-menu-item-container ${open ? 'open' : ''}`}>
        ...
        <Link to="/movies" onClick={() => setOpen(false)} className="nav-item-link">
          <p className="navbar-menu-item">MOVIES</p>
        </Link>
        <Link to="/comics" onClick={() => setOpen(false)} className="nav-item-link">
          <p className="navbar-menu-item">COMICS</p>
        </Link>
        <Link to="/characters" onClick={() => setOpen(false)} className="nav-item-link">
          <p className="navbar-menu-item">CHARACTERS</p>
        </Link>
        <Link to="/tvshows" onClick={() => setOpen(false)} className="nav-item-link">
          <p className="navbar-menu-item">TV SHOWS</p>
        </Link>
        <Link to="/news" onClick={() => setOpen(false)} className="nav-item-link">
          <p className="navbar-menu-item">NEWS</p>
        </Link>
        <Link to="/games" onClick={() => setOpen(false)} className="nav-item-link">
          <p className="navbar-menu-item">GAMES</p>
        </Link>
        <Link to="/videos" onClick={() => setOpen(false)} className="nav-item-link">
